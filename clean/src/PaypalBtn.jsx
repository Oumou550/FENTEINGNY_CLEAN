    ...
    render() {
        const onSuccess = (payment) => {
            // Congratulation, it came here means everything's fine!
                    ...
                    this.props.transSuccess(payment, this.props.total, this.props.service)
        }
        ...
        const client = {
            sandbox:    'ATpuTtl-89Hl9Y3fi0GGWZxW-l2LZPCo1WzTgKfyytlCAus5ug1Yiiz1YimkwRAPFw3B0NqHxRlqwcCG',
