...
export default function DashbordRecyclage1() {
  return (
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col"> <span
                                                className="h6 font-semibold text-muted text-sm d-block mb-2">Déchets plastiques</span>
                                            <span className="h3 font-bold mb-0">350 kg</span>
                                        </div>
